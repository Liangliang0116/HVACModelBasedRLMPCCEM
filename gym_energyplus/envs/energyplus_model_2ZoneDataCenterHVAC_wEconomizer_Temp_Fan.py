...
class EnergyPlusModel2ZoneDataCenterHVAC_wEconomizer_Temp_Fan(EnergyPlusModel):
    ...
    def compute_reward(self, raw_state=None):
        rew, _ = self._compute_reward(raw_state)
        return rew
    ...
    def compute_reward_center23_5_gaussian1_0_trapezoid0_1_pue0_0(self, raw_state=None):  # gaussian/trapezoid, PUE
        return self.compute_reward_common(
            ...
            PUE_weight=0.0,
            Whole_Building_Power_weight=1 / 100000.0,  # NOTE: Is this weight too small? 
            raw_state=raw_state)
    ...
    def compute_reward_common(self,
        ...
        # Temp. gaussian
        rew_temp_gaussian1 = np.exp(-(Tz1 - temperature_center) * (Tz1 - temperature_center) * 
                                    temperature_gaussian_sharpness) * temperature_gaussian_weight
        rew_temp_gaussian2 = np.exp(-(Tz2 - temperature_center) * (Tz2 - temperature_center) * 
                                    temperature_gaussian_sharpness) * temperature_gaussian_weight
